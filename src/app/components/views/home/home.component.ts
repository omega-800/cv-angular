...
export class HomeComponent {
  ...
  mysteriousLinks2 = [
    ...
    'https://open.spotify.com/track/1KCXcyFDR7CnrRvpeQTQkY?si=54a21510ac7e42fb',
  ];

  text1 =
    'Als leidenschaftlicher Problemlöser und kreativer Geist habe ich mir zum Ziel gesetzt, innovative Lösungen zu realisieren und durch ';
  text2 = 'jk just give me money plz. here are some ';
  btnText1 = 'meine Arbeit';
  btnText2 = 'cool reference projects';
  endText1 =
    ' einen positiven Einfluss zu hinterlassen. Sei es durch das Entwickeln von Applikationen mit Mehrwert, Wissensvermittlung an die kommenden Generationen oder das Kreieren von Kunstwerken, die die Menschen erreichen und erfreuen sollen.';
  endText2 =
  ...
  ngOnInit(): void {
    setInterval(() => (this.showLinks = true), 6000);
    setTimeout(() => setInterval(() => (this.showLinks = false), 6000), 1000);
  }
  mailMe = () => {
