...
export class ProjectService {
  ...
  constructor(private personService: PersonService, private careerService: CareerService, private skillService: SkillService, private storage:AngularFireStorage) {
