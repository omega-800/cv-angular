...
import { CareerEntity, CareerOnly } from './career.model';
...
export class CareerService {
  ...
  fillCareer(career:CareerOnly, workplaceService:WorkplaceService, schoolService:SchoolService):CareerEntity {
    if(career.workplace_id !== ""){
      return {...career, id:"career_"+career.career_id, workplace:workplaceService.getWorkplaceById(career.workplace_id)}
    }
    if(career.school_id !== ""){
      return {...career, id:"career_"+career.career_id, school:schoolService.getSchoolById(career.school_id)}
    }
    return {...career, id:career.career_id}
  }
}
